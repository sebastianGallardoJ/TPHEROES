...
app.get('/turingREAL',(req,res) => res.sendFile(path.join(__dirname,'views','turingREAL.html')))
app.get('/*',(req,res) => res.sendFile(path.join(__dirname,'views','404.html')))



app.listen(3030, () => console.log('el servidor ha sido levantado en el puerto 3030') )